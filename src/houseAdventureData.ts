...
export const houseScenesData = {
  ...
  listenAndEscape: {
    ...
    choices: [
      { label: "Investigate the parlor", next: "investigateParlor" },
      { label: "Look for a key to the front door", next: "fireplaceKey" },
  ...
  matchTornPagesToDiary: {
    ...
    choices: [
      ...
      { label: "Retrieve the key from the fireplace", next: "fireplaceKey", hideWhenFlags: { hasKey: true } },
  ...
  loveAlwaysWinsEnding: {
    ...
    textRules: [
      {
        whenMissingFlags: ["hasKnife"],
        find: "\"Okay.\" You reach for the knife.",
        replace: "\"Okay.\" You reach for the small ritual blade lying among the Guardian's instruments.",
      },
    ],
  ...
  giveHerLetters: {
    ...
    textRules: [
      {
        whenMissingFlags: ["knowsIsabelletta"],
        find: "You find her in the garden, exactly where you left her.",
        replace: "You follow the pull of the house down to the garden.",
      },
    ],
